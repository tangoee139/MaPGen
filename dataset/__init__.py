...
from .medical_dataset import generation_mri_train,generation_mri_eval


def create_dataset(dataset, args):
    ...
    if dataset =='generation_iu_xray':
        ...
        return train_dataset, val_dataset, test_dataset
    elif dataset == 'generation_mri':
        train_data = '/mnt/nfs_share/liuzy/PromptMRG/data/label_train_largerData_removeKey.csv'
        #train_data = '/home/huy/PromptMRG/data/label_train_5w_largerData_removeKey.csv'
        val_data = '/mnt/nfs_share/liuzy/PromptMRG/data/label_val_largerData_removeKey.csv'
        test_data = '/mnt/nfs_share/liuzy/PromptMRG/data/label_test_largerData_removeKey.csv'
        
        train_dataset = generation_mri_train(transform_train, ann_root=train_data, dataset='mri', args=args)
        val_dataset = generation_mri_eval(transform_test, ann_root=val_data, dataset='mri', args=args)
        test_dataset = generation_mri_eval(transform_test, ann_root=test_data, dataset='mri', args=args)
        return train_dataset, val_dataset, test_dataset
...
def create_dataset_test(dataset, tokenizer, args):
    ...
    if dataset =='generation_iu_xray':
        ...
        test_data = '/mnt/nfs_share/liuzy/PromptMRG/data/label_test_largerData.csv'
        test_dataset = generation_mri_eval(transform_test, args.image_dir, ann_root=test_data, tokenizer=tokenizer, dataset='mri', args=args)
        return test_dataset
