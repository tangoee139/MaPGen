...
def parse_agrs():
    ...
    parser.add_argument('--dataset_name', type=str, default='mri', choices=['iu_xray', 'mimic_cxr','mri'], help='the dataset to be used.')
    parser.add_argument('--threshold', type=int, default=3, help='the cut off frequency for the words.')
    parser.add_argument('--num_workers', type=int, default=2, help='the number of workers for dataloader.')
    parser.add_argument('--batch_size', type=int, default=16, help='the number of samples for a batch')
    parser.add_argument('--sample_n', type=int, default=0, help='the sample number of train_set and test_set if 0 not sample')

    # Model settings 
    parser.add_argument('--load_pretrained', type=str, default='results/promptmrgknee_new_ddp/model_best.pth', help='pretrained path if any')

    # Sample related
    parser.add_argument('--beam_size', type=int, default=3, help='the beam size when beam searching.')
    parser.add_argument('--gen_max_len', type=int, default=100, help='the maximum token length for text generation.')
    parser.add_argument('--gen_min_len', type=int, default=0, help='the minimum token length for text generation.')

    # Trainer settings
    parser.add_argument('--n_gpu', type=int, default=1, help='the number of gpus to be used.')
    parser.add_argument('--epochs', type=int, default=100, help='the number of training epochs.')
    parser.add_argument('--save_dir', type=str, default='results/promptmrgknee_ddp_sdl', help='the patch to save the models.')
    ...
    parser.add_argument('--sdl', type=bool, default=False, help='use sdl or not')
    parser.add_argument('--ddp', type=bool, default=False, help='use ddp or not')
    parser.add_argument('--cfe', type=bool, default=False, help='use cfe or not')
    parser.add_argument('--new_ddp', type=bool, default=True, help='use ddp or not')
    parser.add_argument('--num_label', type=int, default=300, help='only for mri')
    parser.add_argument('--bert_type', type=str, default='bert-base-chinese', help='only for mri')
...
def main():
    ...
    if args.dataset_name!='mri':
        ...
        labels_temp = ['[BLA]'] * args.num_label
